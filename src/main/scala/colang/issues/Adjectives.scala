...
object Adjectives {
  ...
  object Overloaded extends Adjective {
    val en_US = new EnglishAdjective("overloaded")

    val be_BY = new BelarusianAdjective(
      """перагружаны   перагружаная перагружанае  перагружаныя
        |перагружанага перагружанай перагружанага перагружаных
        |перагружанаму перагружанай перагружанаму перагружаным
        |перагружаны   перагружаную перагружанае  перагружаныя
        |перагружаным  перагружанай перагружаным  перагружанымі
        |перагружаным  перагружанай перагружаным  перагружаных
      """.stripMargin)

    val ru_RU = new RussianAdjective(
      """перегруженный  перегруженная перегруженное  перегруженные
        |перегруженного перегруженной перегруженного перегруженных
        |перегруженному перегруженной перегруженному перегруженным
        |перегруженный  перегруженную перегруженное  перегруженные
        |перегруженным  перегруженной перегруженным  перегруженными
        |перегруженном  перегруженной перегруженном  перегруженных
      """.stripMargin)
  }
}
